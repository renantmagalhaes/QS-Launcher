...
Singleton {
    ...
    function refreshApplications() {
        if (typeof DesktopEntries !== "undefined") {
            ...
            applications = [
                { id: "firefox", name: "Firefox", icon: "firefox", comment: "Web Browser", categories: ["Network", "WebBrowser"], exec: "firefox" },
                { id: "terminal", name: "Terminal", icon: "utilities-terminal", comment: "Package Manager / Shell", categories: ["System", "Utility"], exec: "foot" },
                { id: "files", name: "Files", icon: "folder", comment: "File Manager", categories: ["Utility"], exec: "nautilus" },
                { id: "discord", name: "Discord", icon: "discord", comment: "Chat App", categories: ["Network"], exec: "discord" },
                { id: "settings", name: "Settings", icon: "settings", comment: "System Configuration", categories: ["Settings"], exec: "dms settings" }
            ];
        }
