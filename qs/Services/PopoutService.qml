...
Singleton {
    ...
    function openDankSpotlightWithQuery(query: string) {
        if (dankLauncherV2Modal) {
    ...
    function openDankSpotlightWithMode(mode: string) {
        if (dankLauncherV2Modal) {
    ...
    function closeDankSpotlight() {
        dankLauncherV2Modal?.hide();
    }

    function unloadDankSpotlight() {
    ...
    function toggleDankSpotlightWithMode(mode: string) {
        if (dankLauncherV2Modal) {
    ...
    function toggleDankSpotlightWithQuery(query: string) {
        if (dankLauncherV2Modal) {
    ...
    function _onDankSpotlightModalLoaded() {
